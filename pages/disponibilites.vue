<template>
  ...
  <ul class="p-2 shadow menu dropdown-content z-[1] bg-blue-500 rounded-box w-52">
    ...
    <li><a @click="display_availability('mardi')">Jeudi</a></li>
    <li><a @click="display_availability('lundi')">Vendredi</a></li>
    <li><a @click="display_availability('mardi')">Samedi</a></li>
    <li><a @click="display_availability('lundi')">Dimanche</a></li>
  </ul>
    </details>
...
let isChartMounted = ref(false)
    ...
    onMounted(() => 
        {
            if (isChartMounted.value === true)
            {
                const ctx = document.getElementById('myChart') as HTMLCanvasElement;
                const myChart = new Chart(ctx, {
                    type: 'line',
                    data: {
                        labels: ['00h00', '00h30', '1h00', '1h30', '2h00', '02h30', '3h00', '3h30', '4h00', '4h30','05h00', '05h30', '6h00', '6h30', '7h00','07h30', '08h00', '8h30', '9h00', '9h30','10h00', '10h30', '11h00', '11h30', '12h00','12h30', '13h00', '13h30', '14h00', '14h30','15h00', '15h30', '16h00', '16h30', '17h00','17h30', '18h00', '18h30', '19h00', '19h30','20h00', '20h30', '21h00', '21h30', '22h00','22h30', '23h30'],
                        datasets: [{
                            label: 'Nombre de personne disponible selon l\'heure',
                            data: [heures.value[0][1], heures.value[1][1], heures.value[0][1], heures.value[1][1], heures.value[2][1], heures.value[3][1],heures.value[4][1], heures.value[5][1], heures.value[6][1],heures.value[7][1], heures.value[8][1], heures.value[9][1], heures.value[10][1],heures.value[11][1], heures.value[12][1], heures.value[13][1],heures.value[14][1], heures.value[15][1], heures.value[16][1], heures.value[17][1],heures.value[18][1], heures.value[19][1], heures.value[20][1],heures.value[21][1], heures.value[22][1], heures.value[23][1], heures.value[24][1],heures.value[25][1], heures.value[26][1], heures.value[27][1],heures.value[28][1], heures.value[29][1], heures.value[30][1], heures.value[31][1],heures.value[32][1], heures.value[33][1], heures.value[34][1],heures.value[35][1],heures.value[36][1], heures.value[37][1], heures.value[38][1],heures.value[39][1],heures.value[40][1], heures.value[41][1], heures.value[42][1],heures.value[43][1], heures.value[44][1], heures.value[45][1],heures.value[46][1],heures.value[47][1]],

<template>
    <div>
        <div class="alert alert-success" v-if="created || updated">
        ...
        <div class="flex justify-between my-4">
            ...
            <ClientOnly>
                <RouterLink v-if="user.is_sarah" :to="`/admin/RP/${id}/modifier`" class="btn btn-secondary">
                    Modifier
                </RouterLink>
            </ClientOnly>
        </div>

        <div class="banner" :style="`background-image:url(${roleplay.illustration})`"></div>
...
if (query.hasOwnProperty('created')) created.value = true
if (query.hasOwnProperty('updated')) updated.value = true

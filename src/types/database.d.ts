        ...
        Tables: {
            ...
            messages: {
                ...
                Relationships: [
                    ...
                    {
                        foreignKeyName: 'messages_roleplay_id_fkey'
                        columns: ['roleplay_id']
                        isOneToOne: false
                        referencedRelation: 'roleplays'
                        referencedColumns: ['id']
            ...
            participations: {
                ...
                Relationships: [
                    {
                        foreignKeyName: 'participations_character_id_fkey'
                    ...
                    {
                        foreignKeyName: 'participations_role_id_fkey'
                        columns: ['role_id']
                        isOneToOne: false
                    ...
                    {
                        foreignKeyName: 'participations_roleplay_id_fkey'
                        columns: ['roleplay_id']
                        isOneToOne: false
                        referencedRelation: 'roleplays'
                        referencedColumns: ['id']
